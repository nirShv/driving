...
const FAQ = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer: "המחיר הוא 165 ש''ח לפגישה, מספר הפגישות והתדירות שלהן אישי עבור כל נהג.",
    },
    {
      question: "איך מתאמים פגישה?",
      answer: "יש כפתור לתיאום ליווי און-ליין, ניתן לכתוב מייל ואחזור אליכם ותמיד ניתן לחייג או לכתוב לי וואטספ.",
    },
    {
